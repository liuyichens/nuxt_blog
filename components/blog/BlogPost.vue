...
<template>
  <div class="p-3.5 flex flex-nowrap gap-5" data-aos="fade-up"
    ...
    <div class="left">
      <NuxtLink :to="path" class="absolute top-0 left-0 w-full h-full rounded overflow-hidden" v-if="image">
        <img class="object-cover w-full h-full max-w-full" width="480" height="300" :src="image"
             alt="cover" />
      </NuxtLink>
    </div>
    <div class="right">
      <h2 class="text-base sm:text-2xl font-medium text-gray-900 title-font mb-2 dark:text-white" v-if="title">
